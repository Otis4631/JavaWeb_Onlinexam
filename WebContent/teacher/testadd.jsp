...
<fieldset class="layui-elem-field layui-field-title">
		<legend>
			<b>${user.name}老师，</b>欢迎来到发布试卷页面</legend>
</fieldset>
		...
		<form id="form1" name="form1" method="post" class="ui form"
			...
			<div class="field">
				...
				<div class="field">
					<label>试卷名称为： </label>
					<div class="ui input">
						<input type="text" name="testname" value="徐树林的试卷" class="" onfocus="clearError(this);"
				...
				<div class=" two fields">
					...
					<div class="field">
						<label>题目总数</label> <input value="10" name="sinnum" type="text"
				...
				<div class="field">
					<label>面向的班级</label>
					 <select multiple="" id="cho" name="classCheck" onchange="nullCheck('cho');" class="ui dropdown" onfocus="clearError(this);">
						...
						<option id="errormsg" value='' disabled  style='display:none;'>请选择班级</option> 
					</select>
