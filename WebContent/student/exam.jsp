			...
			<div>
				<div>
					...
					<div id="fd" style="display:none;">
						<span style="color: #ff0000">考试剩余时间</span>
						<br />
					...
					<p class="text"></p>
						<div id="submitButton" >
							<button name="button2" id="button2" value="" class="layui-btn layui-btn-normal">交卷</button>
						</div>
		</form>
		<label>
